...
function EmptyState() {
  return (
    <section aria-label="Empty state" className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white/80 p-10 text-center shadow-sm backdrop-blur dark:border-slate-800 dark:bg-slate-900/70 sm:p-14">
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-indigo-50/70 via-transparent to-violet-50/60 dark:from-indigo-500/10 dark:via-transparent dark:to-violet-500/10" aria-hidden="true" />
      ...
      >
        ...
        <p className="mx-auto mt-3 max-w-md leading-relaxed text-slate-600 dark:text-slate-300">
      ...
      <motion.p
        ...
        className="relative mx-auto mt-6 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-slate-500 shadow-sm dark:border-slate-700 dark:bg-slate-800/70 dark:text-slate-400"
      >
